...
f = open('karten.txt', 'w', encoding="utf-8")
f.write("PPN; Jahr; Titel; Coverage; Publisher"  + '\n')
        ...
        if root[1].text == "0":
            ...
            for record in ListRecords:
                ...
                if elementTag:
                    ...
                    if date == "18XX" or date == "186X" or date == "19XX" or date == "17XX" or 1799 < int(date) < 1934:
                        ...
                        elementTag = record.findall(".//{http://purl.org/dc/elements/1.1/}coverage")
                        if elementTag:
                            coverage = elementTag[0].text
                        else:
                            coverage = "none"
                        ...
                        entry = identifier + "; " + date + "; " + title + "; " + coverage + "; " + publisher
                        f.write(entry  + '\n')
